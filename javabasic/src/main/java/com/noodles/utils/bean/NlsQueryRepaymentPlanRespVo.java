...
/**
 * 文件名：SinaQueryRepaymentPlanRespVo.java
 * 描述：还款计划查询-响应
 * 作者：Carl
 * 日期：2018年1月3日下午4:15:47
 */
public class NlsQueryRepaymentPlanRespVo implements Serializable {
	...
	/**还款计划列表*/
	private List<NlsRepaymentPlanDetail> pay_list;
	...
	public NlsQueryRepaymentPlanRespVo() {
	}

	public NlsQueryRepaymentPlanRespVo(String trans_state) {
		this.trans_state = trans_state;
	}

	public NlsQueryRepaymentPlanRespVo(String trans_state, String error_code, String error_msg) {
		this.trans_state = trans_state;
	...
	public List<NlsRepaymentPlanDetail> getPay_list() {
		return pay_list;
	}

	public void setPay_list(List<NlsRepaymentPlanDetail> pay_list) {
