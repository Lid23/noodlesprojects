...
public class ParallelStreamsHarness {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Iterative Sum done in: " + measurePerf(ParallelStreams::iterativeSum, 100_000_0000L) +
         " msecs");
//        System.out.println("Sequential Sum done in: " + measurePerf(ParallelStreams::sequentialSum, 10_000_000L) + " msecs");
//        System.out.println("Parallel forkJoinSum done in: " + measurePerf(ParallelStreams::parallelSum,
// 10_000_000L) + " msecs" );
//        System.out.println("Range forkJoinSum done in: " + measurePerf(ParallelStreams::rangedSum, 10_000_000L) + " msecs");
        System.out.println("Parallel range forkJoinSum done in: " + measurePerf(ParallelStreams::parallelRangedSum1,
                100_000_0000L) + " msecs" );
